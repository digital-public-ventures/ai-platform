...
Our primary goal is to ensure the protection and confidentiality of sensitive data stored by users on DPV AI Platform.
...
For immediate concerns or detailed reports that meet our guidelines, please create an issue in our [issue tracker](https://github.com/digital-public-ventures/ai-platform/issues).

---

_Last updated on **2025-09-30**._
